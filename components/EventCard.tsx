    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-3 pb-6 pl-3 md:pl-5 lg:pl-7">
        ...
        <motion.article
          ...
          className="relative min-h-[220px] overflow-hidden rounded-2xl rounded-br-[64px] border border-white/50 dark:border-white/20 bg-white/30 dark:bg-white/5 p-3 text-zinc-900 dark:text-[#FAFAFA] shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_8px_32px_rgba(0,0,0,0.2)] backdrop-blur-2xl transition-all duration-500 before:absolute before:inset-y-[-20%] before:left-[-70%] before:w-1/2 before:rotate-12 before:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.8),transparent)] dark:before:bg-[linear-gradient(90deg,transparent,rgba(250,250,250,0.42),transparent)] before:opacity-0 before:blur-sm before:transition-all before:duration-700 hover:-translate-y-1 hover:bg-white/40 dark:hover:bg-white/10 hover:border-white/70 dark:hover:border-white/30 hover:before:left-[120%] hover:before:opacity-100 md:min-h-[214px] md:p-3.5"
        >
          {/* External Link */}
          {link && (
            <a
